package com.anwesh.uiprojects.linebentview

/**
 * Created by anweshmishra on 06/05/19.
 */
...
class LineBentView(ctx : Context) : View(ctx) {
    ...
    companion object {
        ...
        fun create(activity : Activity) : LineBentView {
            val view : LineBentView = LineBentView(activity)
